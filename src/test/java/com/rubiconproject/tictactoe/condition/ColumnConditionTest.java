...
public class ColumnConditionTest {
    ...
    @Test
    public void isNotMetOnEmptyColumn() {
        Assert.assertFalse(condition.isMet(grid));
    }

    @Test
    public void isNotMetOnColumnFilledWithTwoMarks() {
        grid.setCell(0, 1, O_MARK);
        grid.setCell(1, 1, O_MARK);
